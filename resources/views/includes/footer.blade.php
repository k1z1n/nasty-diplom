<div class="footer">
    <div class="footer-block section">
        ...
        <div class="footer-block__column">
            <a href="catalog.html" class="footer-block__link">Услуги</a>
            <a href="about.html" class="footer-block__link">О нас</a>
            <a href="#footer" class="footer-block__link">Контакты</a>
        </div>
        <div class="footer-block__column">
            <div class="footer-block__about">Адрес: Гвардейская 2\22</div>
            <a href="tel: 79505050505" class="footer-block__link">Телефон: +79505050505</a>
            <div class="footer-block__about">Почта: пваперке</div>
        </div>
        <div class="footer-block__column">
